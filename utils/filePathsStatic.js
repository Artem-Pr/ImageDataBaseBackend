...
class FilePathsStatic {
    ...
    getOriginalStaticPath() {
        return `${this._host}/${this._static[this._root.source]}${this._filePathsWithoutRootDir.sourceFullName}`
    }
    
    getPreviewStaticPath() {
        return `${this._host}/${this._static[this._root.preview]}${this._filePathsWithoutRootDir.previewFullName}`
    }
    
    getFullSizeJPEGStaticPath() {
        return `${this._host}/${this._static[this._root.preview]}${this._filePathsWithoutRootDir.fullSizeJpgFullName}`
    }
