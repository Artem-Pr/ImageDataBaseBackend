...
const {UPLOAD_TEMP_FOLDER, DATABASE_FOLDER, PREVIEWS_FOLDER, useOriginalNameForPreview} = require('../../constants');
...
jest.mock('../../constants', () => ({
    ...
    useOriginalNameForPreview: true,
}))
...
describe('FilePathsManager', () => {
    ...
    describe('getStringDateFolderName', () => {
        it('should return preview baseFolderName if originalDate = undefined and changeDate = undefined', () => {
            const filePathsManagerInstance = new FilePathsManager(mockedHEICFileDataBlob, root, 'main/2020')
        ...
        it('should return preview baseFolderName', () => {
            const filePathsManagerInstance = new FilePathsManager(mockedJPEGFiledataFromUploadingObject, root, 'main/2020')
            
            expect(filePathsManagerInstance.getStringDateFolderName())
                .toBe('image-jpeg/preview/2019.06.24 - originalDate')
        })
        it('should return preview baseFolderName if originalDate = undefined and changeDate = undefined', () => {
            const filePathsManagerInstance = new FilePathsManager(mockedHEICFiledataFromUploadingObject, root, 'main/2020')
        ...
        it('should return preview baseFolderName for MP4', () => {
            const filePathsManagerInstance = new FilePathsManager(mockedVideoFiledataFromUploadingObject, root, 'main/2020')
    ...
    describe('getPreviewPathWithoutRootDir', () => {
        ...
        it('should return path for JPG (from upload object)', () => {
            const filePathsManagerInstance = new FilePathsManager(mockedJPEGFiledataFromUploadingObject, root, 'main/2020')
            expect(filePathsManagerInstance.getPreviewPathWithoutRootDir(false))
                .toBe('/image-jpeg/preview/2019.06.24 - originalDate/IMG_20190624_110312-preview.jpg')
        })
        it('should return path for HEIC (from upload object)', () => {
            const filePathsManagerInstance = new FilePathsManager(mockedHEICFiledataFromUploadingObject, root, 'main/2020')
            expect(filePathsManagerInstance.getPreviewPathWithoutRootDir(false))
                .toBe('/image-heic/preview/2023.01.27 - changeDate/test-IMG_6538-preview.jpg')
        })
        it('should return fullSize path for HEIC (from upload object)', () => {
            ...
            expect(filePathsManagerInstance.getPreviewPathWithoutRootDir(true))
                .toBe('/image-heic/fullSize/2023.01.27 - changeDate/test-IMG_6538-fullSize.jpg')
        })
        it('should return empty path for HEIC (from upload object)', () => {
            root.targetPreview = UPLOAD_TEMP_FOLDER
            const filePathsManagerInstance = new FilePathsManager(mockedHEICFiledataFromUploadingObject, root, 'main/2020')
            expect(filePathsManagerInstance.getPreviewPathWithoutRootDir(false))
                .toBe('/test-IMG_6538-preview.jpg')
        })
        it('should return path for HEIC (from Blob object)', () => {
            const filePathsManagerInstance = new FilePathsManager(mockedHEICFileDataBlob, root, 'main/2020')
            expect(filePathsManagerInstance.getPreviewPathWithoutRootDir(false))
                .toBe('/image-heic/preview/2012.01.26 - changeDate/test-IMG_6538-preview.jpg')
        })
        it('should return path for MP4 (from Blob object) THIS SHOULD BE NOT THUMBNAIL FILENAME', () => {
            const filePathsManagerInstance = new FilePathsManager(mockedVideoFiledataBlob, root, 'main/2020')
            expect(filePathsManagerInstance.getPreviewPathWithoutRootDir(false))
                .toBe('/video-mp4/preview/2012.01.26 - changeDate/VID_20190623_091549-preview.mp4')
        })
    })
    ...
    describe('createAllFullPathsForTheFile', () => {
        describe('root: default', () => {
            it('should create paths for JPG file from BLOB', () => {
                const filePathsManagerInstance = new FilePathsManager(mockedJPEGFiledataBlob, root, 'main/2020')
                expect(filePathsManagerInstance
                    ...
                    fullPathTargetPreview: "/app/mockedPreviews/image-jpeg/preview/2012.01.26 - changeDate/IMG_20190624_102400-preview.jpg",
                    ...
                    targetFullSizeJpeg: "",
                    targetPreview: "/image-jpeg/preview/2012.01.26 - changeDate/IMG_20190624_102400-preview.jpg",
                })
            ...
            it('should create paths for HEIC file from BLOB', () => {
                ...
                expect(filePathsManagerInstance
                    ...
                    fullPathTargetFullSizeJpeg: "/app/mockedPreviews/image-heic/fullSize/2012.01.26 - changeDate/test-IMG_6538-fullSize.jpg",
                    fullPathTargetPreview: "/app/mockedPreviews/image-heic/preview/2012.01.26 - changeDate/test-IMG_6538-preview.jpg",
                    ...
                    targetFullSizeJpeg: "/image-heic/fullSize/2012.01.26 - changeDate/test-IMG_6538-fullSize.jpg",
                    targetPreview: "/image-heic/preview/2012.01.26 - changeDate/test-IMG_6538-preview.jpg",
                })
            ...
            it('should create paths for MP4 file from BLOB', () => {
                ...
                expect(filePathsManagerInstance
                    ...
                    fullPathTargetFullSizeJpeg: "",
                    fullPathTargetPreview: "/app/mockedPreviews/video-mp4/preview/2012.01.26 - changeDate/VID_20190623_091549-preview.mp4",
                    ...
                    targetFullSizeJpeg: "",
                    targetPreview: "/video-mp4/preview/2012.01.26 - changeDate/VID_20190623_091549-preview.mp4",
                })
            ...
            it('should create paths for JPG file from uploading object', () => {
                ...
                expect(filePathsManagerInstance
                    ...
                    fullPathTargetFullSizeJpeg: "",
                    fullPathTargetPreview: "/app/mockedPreviews/image-jpeg/preview/2019.06.24 - originalDate/IMG_20190624_110312-preview.jpg",
                    ...
                    targetFullSizeJpeg: "",
                    targetPreview: "/image-jpeg/preview/2019.06.24 - originalDate/IMG_20190624_110312-preview.jpg",
                })
            ...
            it('should create paths for HEIC file from uploading object', () => {
                ...
                expect(filePathsManagerInstance
                    ...
                    fullPathTargetFile: "/app/mockedDataBase/main/2020/test-IMG_6538.heic",
                    fullPathTargetFullSizeJpeg: "/app/mockedPreviews/image-heic/fullSize/2023.01.27 - changeDate/test-IMG_6538-fullSize.jpg",
                    fullPathTargetPreview: "/app/mockedPreviews/image-heic/preview/2023.01.27 - changeDate/test-IMG_6538-preview.jpg",
                    originalFile: "mockedUploadTemp/af638985f4b4c4db8e53d2db00a296fe",
                    originalFullSizeJpeg: "mockedUploadTemp/af638985f4b4c4db8e53d2db00a296fe-fullSize.jpg",
                    originalPreview: "mockedUploadTemp/af638985f4b4c4db8e53d2db00a296fe-preview.jpg",
                    targetFile: "/main/2020/test-IMG_6538.heic",
                    targetFullSizeJpeg: "/image-heic/fullSize/2023.01.27 - changeDate/test-IMG_6538-fullSize.jpg",
                    targetPreview: "/image-heic/preview/2023.01.27 - changeDate/test-IMG_6538-preview.jpg",
                })
        ...
        describe('root: targetPreview: UPLOAD_TEMP_FOLDER', () => {
            ...
            it('should create paths for JPG file from BLOB', () => {
                ...
                expect(filePathsManagerInstance
                    ...
                    fullPathTargetFile: "/app/mockedDataBase/main/2020/IMG_20190624_102400.jpg",
                    fullPathTargetFullSizeJpeg: "",
                    fullPathTargetPreview: "mockedUploadTemp/IMG_20190624_102400-preview.jpg",
                    originalFile: "mockedUploadTemp/4b5ebcfca0376e1131960a1244807c53",
                    originalFullSizeJpeg: "",
                    originalPreview: "mockedUploadTemp/4b5ebcfca0376e1131960a1244807c53-preview.jpg",
                    targetFile: "/main/2020/IMG_20190624_102400.jpg",
                    targetFullSizeJpeg: "",
                    targetPreview: "/IMG_20190624_102400-preview.jpg",
                })
            ...
            it('should create paths for HEIC file from BLOB', () => {
                ...
                expect(filePathsManagerInstance
                    ...
                    fullPathTargetFile: "/app/mockedDataBase/main/2020/test-IMG_6538.heic",
                    fullPathTargetFullSizeJpeg: "mockedUploadTemp/test-IMG_6538-fullSize.jpg",
                    fullPathTargetPreview: "mockedUploadTemp/test-IMG_6538-preview.jpg",
                    originalFile: "mockedUploadTemp/af638985f4b4c4db8e53d2db00a296fe",
                    originalFullSizeJpeg: "mockedUploadTemp/af638985f4b4c4db8e53d2db00a296fe-fullSize.jpg",
                    originalPreview: "mockedUploadTemp/af638985f4b4c4db8e53d2db00a296fe-preview.jpg",
                    targetFile: "/main/2020/test-IMG_6538.heic",
                    targetFullSizeJpeg: "/test-IMG_6538-fullSize.jpg",
                    targetPreview: "/test-IMG_6538-preview.jpg",
                })
            ...
            it('should create paths for MP4 file from BLOB', () => {
                ...
                expect(filePathsManagerInstance
                    ...
                    fullPathTargetFile: "/app/mockedDataBase/main/2020/VID_20190623_091549.mp4",
                    fullPathTargetFullSizeJpeg: "",
                    fullPathTargetPreview: "mockedUploadTemp/VID_20190623_091549-preview.mp4",
                    originalFile: "mockedUploadTemp/3e09f0cfef2b8b8598aa38049f0cdba7",
                    originalFullSizeJpeg: "",
                    originalPreview: "mockedUploadTemp/3e09f0cfef2b8b8598aa38049f0cdba7-preview.jpg",
                    targetFile: "/main/2020/VID_20190623_091549.mp4",
                    targetFullSizeJpeg: "",
                    targetPreview: "/VID_20190623_091549-preview.mp4",
                })
            ...
            it('should create paths for JPG file from uploading object', () => {
                ...
                expect(filePathsManagerInstance
                    ...
                    fullPathTargetFile: "/app/mockedDataBase/main/2020/IMG_20190624_110312.jpg",
                    fullPathTargetFullSizeJpeg: "",
                    fullPathTargetPreview: "mockedUploadTemp/IMG_20190624_110312-preview.jpg",
                    originalFile: "mockedUploadTemp/49dd3818db90f12b55c851d1e923f6d2",
                    originalFullSizeJpeg: "",
                    originalPreview: "mockedUploadTemp/49dd3818db90f12b55c851d1e923f6d2-preview.jpg",
                    targetFile: "/main/2020/IMG_20190624_110312.jpg",
                    targetFullSizeJpeg: "",
                    targetPreview: "/IMG_20190624_110312-preview.jpg",
                })
        ...
        describe('root: from Database to Upload folder', () => {
            const JPEGFiledata = {
                ...
                "type": "image/jpeg",
                "fullSizeJpgPath": "",
                "preview": "http://localhost:5000/upload_images/IMG_20190624_102400-preview.jpg",
            ...
            const HEICFiledata = {
                ...
                "size": 918700,
                "type": "image/heic",
                "fullSizeJpgPath": "uploadTemp/IMG_20190624_102400-fullSize.heic",
                "preview": "http://localhost:5000/upload_images/IMG_20190624_102400-preview.jpg",
                "tempPath": "uploadTemp/IMG_20190624_102400.heic",
                "originalPath": "http://localhost:5000/upload_images/IMG_20190624_102400-fullSize.jpg",
                "originalDate": "2019.06.24 11:03",
                "keywords": null,
                "megapixels": "",
                "rating": 0,
            ...
            it('should create paths for JPG file from JPEGFiledata', () => {
                const filePathsManagerInstance = new FilePathsManager(JPEGFiledata, root, 'main/2020')
                expect(filePathsManagerInstance
                    .createAllFullPathsForTheFile()
                    .fullPathsObj
                ).toEqual({
            ...
            it('should create paths for HEIC file from HEICFiledata', () => {
                const filePathsManagerInstance = new FilePathsManager(HEICFiledata, root, 'main/2020')
                expect(filePathsManagerInstance
                    .createAllFullPathsForTheFile()
                    .fullPathsObj
                ).toEqual({
                    fullPathTargetFile: "",
                    fullPathTargetFullSizeJpeg: "mockedUploadTemp/IMG_20190624_102400-fullSize.jpg",
                    fullPathTargetPreview: "mockedUploadTemp/IMG_20190624_102400-preview.jpg",
                    originalFile: "/app/mockedDataBase/main/2020/IMG_20190624_102400.heic",
                    originalFullSizeJpeg: "",
                    originalPreview: "",
                    targetFile: "",
                    targetFullSizeJpeg: "/IMG_20190624_102400-fullSize.jpg",
                    targetPreview: "/IMG_20190624_102400-preview.jpg",
                })
